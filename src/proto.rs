...
// See: https://stackoverflow.com/a/50223259
// macro_rules! impl_future {
//   (for $($t:ty),+) => {
//       // Implement future trait for all these bois
//       $(impl Future for $t {

//           type Output = $t; //io::Result<i32>;
...
impl<'de> ::serde::Deserialize<'de> for DeviceAddrfamily {
        ...
        D: ::serde::Deserializer<'de>,
    {
        ...
        impl<'a> ::serde::de::Visitor<'a> for Visitor {
            ...
            {
                match value {
                    DeviceTcp => Ok(DeviceAddrfamily::DeviceTcp),
                    DeviceUdp => Ok(DeviceAddrfamily::DeviceUdp),
...
pub fn encode(msg: DeviceAsyncResponse, buf: &mut Vec<u8>) -> io::Result<()> {
    match msg {
...
pub fn _encode(msg: DeviceCoreResponse, buf: &mut Vec<u8>) -> io::Result<()> {
    match msg {
...
pub fn __encode(msg: DeviceIntrResponse, buf: &mut Vec<u8>) -> io::Result<()> {
    match msg {
