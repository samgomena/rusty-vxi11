...
struct Create_LinkParms {
	...
	unsigned hyper lock_timeout; 	/* time to wait on a lock */
...
struct Create_LinkResp {
	...
	unsigned hyper maxRecvSize; 	/* specifies max data size in bytes device will accept on a write */ };

struct Device_WriteParms {
	Device_Link lid; 					/* link id from create_link */
	unsigned hyper io_timeout; 			/* time to wait for I/O */
	unsigned hyper lock_timeout; 		/* time to wait for lock */
	Device_Flags flags;
...
struct Device_WriteResp {
	Device_ErrorCode error;
	unsigned hyper size; 	/* Number of bytes written */
};

struct Device_ReadParms {
	Device_Link lid; 					/* link id from create_link */
	unsigned hyper requestSize; 		/* Bytes requested */
	unsigned hyper io_timeout; 			/* time to wait for I/O */
	unsigned hyper lock_timeout; 		/* time to wait for lock */
...
struct Device_RemoteFunc {
	unsigned hyper hostAddr; 		/* Host servicing Interrupt */
	unsigned int hostPort; 			/* valid port # on client */
	unsigned hyper progNum; 		/* DEVICE_INTR */
	unsigned hyper progVers; 		/* DEVICE_INTR_VERSION */
...
struct Device_LockParms {
	...
	unsigned hyper lock_timeout; 	/* time to wait to acquire lock */
};

struct Device_DocmdParms {
	Device_Link lid; 				/* link id from create_link */
	Device_Flags flags; 			/* flags specifying various options */
	unsigned hyper io_timeout;		/* time to wait for I/O to complete */
	unsigned hyper lock_timeout; 	/* time to wait on a lock */
